            ...
            <nav class="relative flex items-center justify-between sm:h-10 md:justify-center" aria-label="Global">
                <div class="flex items-center flex-1 md:absolute md:inset-y-0 md:left-0">
                    <div class="flex items-center justify-between w-full md:w-auto">
                            <NuxtLink to="/">
                                <img class="w-auto h-8 sm:h-10" src="http://tinyurl.com/2bry9mct" loading="lazy" width="202" height="40">
                            </NuxtLink>
                ...
                <div class="hidden md:flex md:space-x-10 list-none">
                    <li>
                        <NuxtLink class="text-base font-semibold list-none hover:opacity-75" to="/">Home</NuxtLink>
                    </li>
                    <li>
                        <NuxtLink class="text-base font-semibold list-none hover:opacity-75" to="/explore">Explore</NuxtLink>
                    </li>
                    <li>
                        <NuxtLink class="text-base font-semibold list-none hover:opacity-75" to="/support">Support</NuxtLink>
                    </li>
                </div>
